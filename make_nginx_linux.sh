...
./configure --prefix=/home/www/nginx --with-ld-opt="-lstdc++ -lstdc++fs" --with-pcre=third_party/pcre --with-http_ssl_module --with-openssl=third_party/openssl  --add-module=third_party/nginx_backtrace --add-module=online_license/ngx_license
make -j8
make install
make clean
rm -rf third_party/pcre
